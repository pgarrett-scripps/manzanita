# Ported from intervaltree test/issues/issue67_test.py
"""
Test module: IntervalTree, insertion of a sequence of intervals caused
invariant violation
Submitted as issue #67 by suola
"""
...
def test_interval_insertion_67():
    ...
    for interval in intervals:
        tree.addi(*interval)
    # Tree should be valid after all insertions
    assert len(tree) == len(intervals)
